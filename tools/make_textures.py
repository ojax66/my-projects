...
if __name__ == "__main__":
    ...
    write_png(os.path.join(root, "packs/Space Dimension RP/textures/space_dim/star.png"), 16, 16, star_texture())
    icon = pack_icon()
    for p in ("packs/Space Dimension BP/pack_icon.png", "packs/Space Dimension RP/pack_icon.png"):
