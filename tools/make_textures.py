...
if __name__ == "__main__":
    ...
    write_png(os.path.join(root, "packs/Galactic Horizons RP/textures/space_dim/star.png"), 16, 16, star_texture())
    icon = pack_icon()
    for p in ("packs/Galactic Horizons BP/pack_icon.png", "packs/Galactic Horizons RP/pack_icon.png"):
