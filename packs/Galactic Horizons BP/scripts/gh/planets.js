...
const MOON = {
  ...
  dimensionId: "gh:moon",
  name: "§7Lua",
  defaultBiome: "gh:lua_terras_altas",
  ...
  blocks: {
    dust: "gh:moon_regolith_light",
    stone: "gh:moon_regolith",
    deep: "gh:moon_regolith_dark",
  ...
  // --- Minérios ------------------------------------------------------------
  // `ore` é o tipo (tools/assets/ores.json diz a aparência e o que ele larga);
  ...
  //
  // Cada tipo existe em duas pedras — a do meio da crosta e a ardósia funda. O
  // gerador escolhe a variante pelo bloco que está substituindo, então aqui não
  // se fala nisso.
  //
  // O QUE A LUA TEM: silício e titânio, que é o que existe de verdade no
  // regolito lunar. Ferro e ouro são MUITO RAROS e diamante é quase impossível:
  // esses três vêm da geologia da Terra — água, tectônica e pressão de manto —
  // e nada disso aconteceu aqui. O pouco de ferro que há é meteórico.
  ores: {
    ...
    list: [
      { ore: "silicon", from: 2, to: 28, weight: 40 },
      { ore: "titanium", from: 6, to: 28, weight: 26 },
      { ore: "helium3", from: 12, to: 28, weight: 14 },
      { ore: "redstone", from: 14, to: 28, weight: 12 },
      { ore: "iron", from: 3, to: 28, weight: 5 },
      { ore: "gold", from: 12, to: 28, weight: 2.5 },
  ...
  biomes: [
    ...
    {
      id: "bacia_de_impacto",
      biomeId: "gh:lua_bacia_de_impacto",
...
const MARS = {
  ...
  dimensionId: "gh:mars",
  name: "§cMarte",
  defaultBiome: "gh:marte_terras_altas_do_sul",
  fog: "gh:fog_mars",
  skyColor: "#C7A180",
  ...
  // --- Minérios ------------------------------------------------------------
  // Silício e titânio como na Lua, e cobre, que é o exclusivo daqui. O ferro de
  // Marte está TODO oxidado e espalhado na poeira — é o que deixa o planeta
  // vermelho —, e óxido espalhado não vira veio: achar minério de ferro aqui é
  // raro. Ouro mais ainda, e diamante é quase impossível, pelo mesmo motivo da
  // Lua: falta a geologia que os concentra.
  ores: {
    vein: 6.5,
    rarity: 0.12,
    threshold: 0.58,
    list: [
      { ore: "silicon", from: 2, to: 28, weight: 38 },
      { ore: "titanium", from: 6, to: 28, weight: 22 },
      { ore: "copper", from: 4, to: 28, weight: 20 },
      { ore: "iron", from: 2, to: 28, weight: 6 },
      { ore: "gold", from: 12, to: 28, weight: 2.5 },
      { ore: "diamond", from: 20, to: 28, weight: 0.4 },
    ],
  },
  ...
  biomes: [
    {
      id: "planicie_boreal",
      biomeId: "gh:marte_planicie_boreal",
      name: "§6Planície Boreal",
      dust: [4, 8],
      stone: [8, 12],
      craterScale: 0.5,
      fog: "gh:fog_mars_dust",
    },
    {
      id: "terras_altas_do_sul",
      biomeId: "gh:marte_terras_altas_do_sul",
    ...
    {
      id: "campo_de_dunas",
      biomeId: "gh:marte_campo_de_dunas",
    ...
    {
      id: "calota_polar",
      biomeId: "gh:marte_calota_polar",
      name: "§fCalota Polar",
      dust: [2, 4],
      stone: [8, 12],
      craterScale: 0.3,
      fog: "gh:fog_mars_polar",
