 ...
 *
 * Os trajes daqui (básico e reforçado) são selados e valem sozinhos: não existe
 * item de oxigênio neste addon, e o básico é justamente o traje que o jogador
...
export function canBreathe(player) {
  ...
  // item de oxigênio neste addon pra uma mochila consumir, e o básico precisa
  // funcionar sozinho — ele é o que existe ANTES da primeira subida. O reforçado
  // é o básico melhorado, então não pode exigir mais que ele.
