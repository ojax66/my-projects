 ...
 *
 * O mesmo caminho serve pra upgrade de gh: quem quiser abrir um sistema por
 * outro meio chama `unlockSystem` (tracker.js) ou dispara
 * `/scriptevent gh:unlock <sistema>`. O mapa é só a primeira forma.
 * ========================================================================= */
...
const CHART_PREFIX = "gh:star_chart_";
const TRACKER_ITEM = "gh:tracker";
...
//   /scriptevent gh:unlock <id do sistema>
system.afterEvents.scriptEventReceive.subscribe((data) => {
  if (data.id !== "gh:unlock") return;
